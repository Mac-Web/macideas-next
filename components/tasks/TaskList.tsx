    ...
    <div className="flex items-center group relative" ref={menuRef}>
      {rename !== null ? (
        ...
        <Link
          ...
          className={`flex gap-x-3 items-center whitespace-nowrap text-black dark:text-gray-300 px-4 py-2 rounded group-hover:bg-gray-300/60! dark:group-hover:bg-gray-900/60!
            w-full ${pathname.includes(taskList.id) && "bg-gray-300 dark:bg-gray-900 group-hover:bg-gray-300! dark:group-hover:bg-gray-900! text-teal-600 font-bold"}`}
        >
          <Emoji
